...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
LogTape makes it easier for you diagnose what went wrong in your app. Shake your device when something looks odd and inspect network calls, screenshot and recorded videos at a later date. This pod integrates LogTape with AFNetworking.
